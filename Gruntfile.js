		...
		*/
		grunt.initConfig({
			...
			uglify: {
				...
				build: {
					files:  {},
					src:    'ui-bootstrap-tooltip-tpl.js',
					dest:   'ui-bootstrap-tooltip-tpl.min.js'
				}
			},
			less: {
				development: {
					...
					files: {
						"main.css": "_base.less",
						"ui-bootstrap-tooltip-tpl.css": "_ui-bootstrap-tooltip-tpl.less"
					}
				}
			},
			cssmin: {
				dev: {
					src: ['ui-bootstrap-tooltip-tpl.css'],
					dest: 'ui-bootstrap-tooltip-tpl.min.css'
				}
			}/*,
			karma: {
				unit: {
